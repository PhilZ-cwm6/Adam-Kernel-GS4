...
#define MICRO_FREQUENCY_UP_THRESHOLD_H		(100)
...
#define MICRO_FREQUENCY_MIDDLE_THRESHOLD_1	(75)
#define MICRO_FREQUENCY_MIDDLE_THRESHOLD_2	(85)
#define MICRO_FREQUENCY_MIDDLE_THRESHOLD_3	(95)
